...
public class Consulta extends JFrame {
	...
	public Consulta() {
		...
		JLabel lblEatDrink = DefaultComponentFactory.getInstance().createTitle("Eat and Drink");
		...
		JLabel lblTipoDeEstabelecimentos = new JLabel("Resultados de Pesquisa");
		lblTipoDeEstabelecimentos.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblTipoDeEstabelecimentos.setBackground(new Color(0, 0, 0));
		lblTipoDeEstabelecimentos.setBounds(10, 5, 163, 14);
		panel_resultadoPesquisa.add(lblTipoDeEstabelecimentos);
		
		scrollPaneResultadosPesquisa = new JScrollPane();
		scrollPaneResultadosPesquisa.setViewportBorder(new LineBorder(new Color(0, 0, 0)));
		scrollPaneResultadosPesquisa.setBounds(10, 44, 701, 350);
